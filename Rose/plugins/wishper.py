...
IMG = "https://telegra.ph/file/58fe87feaca8c278a4f95.jpg"
...
async def wishper_ai(_, sz: InlineQuery):
    ...
    if query == '' or len(query) > lengths \
        ...
        content = ("**Send whisper messages through inline mode**\n\n"
                   "Usage: `@Miss_Isabella_Robot [@username] text`")
        description = "Usage: @Miss_Isabella_Robot [@username] text"
        button = InlineKeyboardButton(
            "More-Help",
            url="https://t.me/Miss_Isabella_Robot?start=learn"
        )
...
example:- 
@Miss_Isabella_Robot hello this is a test @supunma
